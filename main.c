...
int main() {
    ...
    ft_printf("---------------- testing realloc staying in the same size range ----------------\n");
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 25, _padded(25) - 25, _padded(25) + 16);
    realloc(rea, 25);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 20, _padded(20) - 20, _padded(20) + 16);
    realloc(rea, 20);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 15, _padded(15) - 15, _padded(15) + 16);
    realloc(rea, 15);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 10, _padded(10) - 10, _padded(10) + 16);
    realloc(rea, 10);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 30, _padded(30) - 30, _padded(30) + 16);
    realloc(rea, 30);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 35, _padded(35) - 35, _padded(35) + 16);
    realloc(rea, 35);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 40, _padded(40) - 40, _padded(40) + 16);
    realloc(rea, 40);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 45, _padded(45) - 45, _padded(45) + 16);
    realloc(rea, 45);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 50, _padded(50) - 50, _padded(50) + 16);
    realloc(rea, 50);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 55, _padded(55) - 55, _padded(55) + 16);
    realloc(rea, 55);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 60, _padded(60) - 60, _padded(60) + 16);
    realloc(rea, 60);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 5, _padded(5) - 5, _padded(5) + 16);
    realloc(rea, 5);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 42, _padded(42) - 42, _padded(42) + 16);
    realloc(rea, 42);
        show_alloc_mem_ex();
        ft_printf("reallocing for %d with padding %d so a total size of %d\n", 2, _padded(2) - 2, _padded(2) + 16);
    realloc(rea, 2);
        show_alloc_mem_ex();
    ft_printf("\n");
